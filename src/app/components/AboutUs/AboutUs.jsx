  ...
  if (isClient) {
    return ( 
      ...
      >
        ...
        <h1 className="title-size mx-5 xs:mx-6 sm:mx-8 md:ml-12 max-md:landscape:mt-0 max-lg:drop-shadow-lg">
          Bienvenido a Dutsiland
        </h1>
        <div className="lg:w-1/3 lg:self-end mx-5 xs:mx-6 sm:mx-8 md:mx-12 lg:mx-0 lg:mr-32 2xl:mr-40">
          <h2 className="text-xs xs:text-sm md:text-xl 3xl:text-3xl mb-6 max-lg:drop-shadow-lg">
